...
// and delete the testnet comments.
//
...
// (only unrelated/spam ERC-20s share the ticker): BNB, WBTC, SOL, XRP.
const PRESET_COINS: PresetCoin[] = [
  ...
  {
    symbol: 'USDG',
    name: 'USD Global Dollar',
    // Robinhood Chain Testnet (46630)
    address: '0x915Ef7c9F9f80a69e3BE47A38EE0Bb47607103ec',
    // TODO: REMOVE THIS BEFORE MAINNET LAUNCH — mainnet (4663): 0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168
    icon: '/USDG.webp',
  },
]
...
export default function CreateRafflePage() {
  ...
  // Defaults to TSLA (Robinhood Chain testnet). TODO: REMOVE THIS BEFORE MAINNET LAUNCH — swap for mainnet 0x322F0929c4625eD5bAd873c95208D54E1c003b2d
  const [prizeAsset, setPrizeAsset] = useState<Address>('0xC9f9c86933092BbbfFF3CCb4b105A4A94bf3Bd4E' as Address)
